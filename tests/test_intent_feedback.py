...
class TestIntentFeedbackMapping:
    ...
    def test_begin_recording_rejected_editing_shows_message(self, handler, mock_status_bar):
    ...
    def test_view_transcript_rejected_unsaved_shows_message(self, handler, mock_status_bar):
    ...
    def test_view_transcript_rejected_recording_shows_message(self, handler, mock_status_bar):
