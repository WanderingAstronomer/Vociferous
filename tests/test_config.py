...
class TestConfigManagerInvariants:
    ...
    @pytest.mark.xfail(reason="ConfigManager.load_user_config currently allows arbitrary keys (Deep Update)")
    def test_schema_rejection_of_unknown_keys(self, clean_config_manager, mock_schema, mock_config_path):
    ...
    def test_atomic_write_persistence(self, clean_config_manager, mock_schema, mock_config_path):
    ...
    def test_resilience_to_missing_keys_and_deep_paths(self, clean_config_manager, mock_schema):
    ...
    def test_schema_type_resilience(self, clean_config_manager, mock_schema, mock_config_path):
