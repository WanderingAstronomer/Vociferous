...
class TestBackendCompatibility:
    ...
    def test_evdev_needs_input_group(self):
        ...
        try:
            ...
            user_in_input = username in input_group.gr_mem or os.getgid() == input_group.gr_gid
        except KeyError:
            user_in_input = False
    ...
    def test_evdev_can_list_devices(self):
        ...
        try:
            ...
            pytest.fail("Permission denied accessing input devices. Add user to 'input' group.")
