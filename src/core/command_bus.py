...
from src.core.intents.registry import HandbookRegistry, IntentMetadata
...
class CommandBus(QObject):
    ...
    def register_handler(self, intent_type: type[InteractionIntent], handler: Any) -> None:
    ...
    def dispatch(self, intent: InteractionIntent, allow_ui: bool = True) -> None:
        ...
        # But for Core logic (e.g. SaveSettings), it might be static.
             ...
             try:
                meta.handler(intent) # This assumes the handler function can take the intent
                handled = True
             except Exception as e:
