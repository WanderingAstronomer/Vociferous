...
from ui.utils.history_utils import format_day_header, format_preview, format_time_compact
...
class SearchPanel(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self._results_tree.setSelectionBehavior(QAbstractItemView.SelectionBehavior.SelectRows)
        self._results_tree.setVerticalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self._results_tree.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
