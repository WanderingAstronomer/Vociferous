...
from ui.constants.dimensions import BORDER_RADIUS_LG, BORDER_RADIUS_SMALL
...
QWidget#titleBar {{
    background-color: {c.GRAY_8};
    border-bottom: 3px solid {c.GRAY_6};
}}
