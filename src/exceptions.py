...
class AudioDeviceError(VociferousError):
    ...
    def __init__(self, message: str, context: Optional[dict[str, Any]] = None) -> None:
        super().__init__(
            message,
            context,
            doc_ref="docs/wiki/Audio-Recording.md"
        )
...
class ModelLoadError(VociferousError):
    ...
    def __init__(self, message: str, context: Optional[dict[str, Any]] = None) -> None:
        super().__init__(
            message,
            context,
            doc_ref="docs/wiki/Troubleshooting.md"
        )
...
class TranscriptionError(VociferousError):
    ...
    def __init__(self, message: str, context: Optional[dict[str, Any]] = None) -> None:
        super().__init__(
            message,
            context,
            doc_ref="docs/wiki/Refinement-Architecture.md"
        )
...
class ConfigError(VociferousError):
    ...
    def __init__(self, message: str, context: Optional[dict[str, Any]] = None) -> None:
        super().__init__(
            message,
            context,
            doc_ref="docs/wiki/Configuration-Schema.md"
        )
...
class DatabaseError(VociferousError):
    ...
    def __init__(self, message: str, context: Optional[dict[str, Any]] = None) -> None:
        super().__init__(
            message,
            context,
            doc_ref="docs/wiki/History-Storage.md"
        )
